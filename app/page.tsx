				...
				<section className="container mx-auto px-4 py-20 text-center">
					<div className="max-w-3xl mx-auto space-y-6">
						...
						<p className="text-xl text-muted-foreground text-balance">
							O marketplace completo para photocards de K-pop com sistema de CEG
							integrado
						</p>
					...
					<div className="grid md:grid-cols-3 gap-8">
						<div className="bg-white rounded-lg p-6 shadow-sm">
							...
							<p className="text-muted-foreground">
								Encontre photocards raros dos seus idols favoritos com busca
								avançada e filtros
							</p>
						</div>
						...
						<div className="bg-white rounded-lg p-6 shadow-sm">
							...
							<p className="text-muted-foreground">
								Crie wishlists visuais compartilháveis com template em grid
								personalizável
							</p>
						</div>
						...
						<div className="bg-white rounded-lg p-6 shadow-sm">
							...
							<p className="text-muted-foreground">
								Gerencie compras em grupo nacionais e internacionais com
								facilidade
							</p>
						</div>
					</div>
